...
func Checkpoint(logger log.Logger, w *wal.WAL, m, n int, keep func(id uint64) bool, mint int64, checkpointDeleteTotal, checkpointDeleteFail prometheus.Counter) (*CheckpointStats, error) {
	...
	if checkpointDeleteTotal != nil {
		checkpointDeleteTotal.Inc()
	}
