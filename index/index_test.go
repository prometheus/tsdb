...
func TestIndexRW_Create_Open(t *testing.T) {
	...
	ir, err := NewFileReader(fn, 1, ulid.ULID{})
	testutil.Ok(t, err)
	...
	_, err = NewFileReader(dir, 1, ulid.ULID{})
...
func TestIndexRW_Postings(t *testing.T) {
	...
	ir, err := NewFileReader(fn, 2, ulid.ULID{})
	testutil.Ok(t, err)
...
func TestPersistence_index_e2e(t *testing.T) {
	...
	ir, err := NewFileReader(filepath.Join(dir, "index"), 2, ulid.ULID{})
	testutil.Ok(t, err)
